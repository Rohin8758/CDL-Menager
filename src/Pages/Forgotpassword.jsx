            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
              ...
              >
                ...
                <div>
                  <button
                    type="submit"
                    className="flex w-full justify-center bg-color text-xl font-bold rounded-md bg-indigo-600 px-3 py-1.5 leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  >
                    Recover Password
                  </button>
                </div>
